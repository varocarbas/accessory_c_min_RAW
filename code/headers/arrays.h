...
void* __initialise_array_item(size_t, type, size_t);

void* __initialise_array_items(size_t, type, size_t*);
...
error_warning* get_error_warning_array_value(void*, size_t);

output* get_output_array_value(void*, size_t);

boolean get_boolean_array_value(void*, size_t);

char* get_string_array_value(void*, size_t);
